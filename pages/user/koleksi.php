                        ...
                        <div class="">
                            <ul class="navbar-nav navbar-nav me-auto mb-2 mb-lg-0 row">
                                <li class="nav-item col">
                                    <a class="nav-link active" aria-current="page" href="../user/index.php#home">Home</a>
                                </li>
                                <li class="nav-item col">
                                    <a class="nav-link active" href="koleksi.php">Koleksiku</a>
                                </li>
                                <li class="nav-item col">
                                    <a class="nav-link active" href="../auth/logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
