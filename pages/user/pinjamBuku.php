                ...
                <div class="card-body p-0">
                    <form id="quickForm" action="../../app/Services/authService.php" method="post">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="submit" name="btnTambahData" class="mt-2 btn btn-info">Pinjam
                                            Buku</button>
                                    </div>
                                </div>
                                <div class="col-6">
                      ...
                      <input type="deskripsi" name="deskripsi" class="form-control" id="deskripsi">
                                    ...
                                    <div>
                                        <h5>Deskripsi</h5>
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates ullam
                                            voluptatem optio quod sapiente deserunt doloribus commodi quis veritatis
                                            reprehenderit nesciunt necessitatibus eos, sed recusandae blanditiis
                                            incidunt? Quam, doloribus optio.</p>
                                    </div>
                                    <div>
